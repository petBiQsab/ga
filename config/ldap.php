            ...
            */
            ...
            'settings' => [
                ...
                */
                ...
                'hosts' => explode(' ', env('LDAP_HOSTS', '172.25.1.10')),
                ...
                */
                ...
                'base_dn' => env('LDAP_BASE_DN', 'DC=bratislava, DC=local'),
                ...
                */
                ...
                'username' => env('LDAP_USERNAME', 'intranetldapuser@bratislava.local'),
                'password' => env('LDAP_PASSWORD', 'a123456.A'),
