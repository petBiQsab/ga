...
## Environment for local development in docker

- create docker/local/.env file from .env.example and adjust the values if necessary
- init docker environment
  - via task runner:
    - install Task https://taskfile.dev/ 
    - ```task project-init```
  - via docker-compose:
    - ```source docker/local/.env && docker volume create ${PROJECT_NAME}-db-data```
